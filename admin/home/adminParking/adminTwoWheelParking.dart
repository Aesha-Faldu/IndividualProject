...
class adminTwoWheel extends StatefulWidget {
  final String parkingType;

  adminTwoWheel(this.parkingType);
  @override
  State<adminTwoWheel> createState() => _adminTwoWheelState();
}

class _adminTwoWheelState extends State<adminTwoWheel> {
  late List list;
          ...
          TextField(
            ...
            decoration: InputDecoration(
              ...
              enabledBorder: UnderlineInputBorder(
                borderSide: BorderSide(color: Colors.brown), //<-- SEE HERE
              ),
            ),
          ),
          TextField(
